Shader "DearImGui/Mesh"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/DearImGui/Resources/Shaders/PassesUniversal.hlsl"
            ENDHLSL
        }
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex ImGuiPassVertex
            #pragma fragment ImGuiPassFrag
            #include "Assets/DearImGui/Resources/Shaders/PassesHD.hlsl"
            ENDHLSL
        }
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex ImGuiPassVertex
            #pragma fragment ImGuiPassFrag
            #include "Assets/DearImGui/Resources/Shaders/PassesBuiltin.hlsl"
            ENDCG
        }
    }
}
